...
if($validar->Estado==1){
 $empresa=DB::table('empresa')->select('idEmpresa','Nombre','Imagen','Estado')->where('idEmpresa','=',$id)->get(); //Consulta a la tabla empresa para traer sus datos.
 $articulos=DB::table('articulo as a')
            ...
            ->paginate('12'); //Consulta para traer todos los articulos de la empresa.
